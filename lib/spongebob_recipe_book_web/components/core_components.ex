defmodule SpongebobRecipeBookWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SpongebobRecipeBookWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SpongebobRecipeBookWeb.Gettext, "errors", msg, opts)
    end
  end
